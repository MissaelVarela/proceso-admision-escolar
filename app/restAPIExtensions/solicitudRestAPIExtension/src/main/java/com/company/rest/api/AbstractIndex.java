...
public abstract class AbstractIndex implements RestApiController {
    ...
    public static final String PARAM_ASPIRANTE_ID = "aspirante_id";
    ...
    public RestApiResponse doHandle(HttpServletRequest request, RestApiResponseBuilder responseBuilder, RestAPIContext context) {
        ...
        try {
        	...
        	LOGGER.error("Error durante la ejecución de la logica de negocio de la REST API extension", e);
            return jsonResponse(responseBuilder, SC_INTERNAL_SERVER_ERROR, Error.builder().message(e.getMessage()).build());
        }
    ...
    protected abstract Object execute(RestAPIContext context);
